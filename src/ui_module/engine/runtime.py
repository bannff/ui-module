...
import yaml
import os
from .models import Envelope, View, SessionState
...
class Runtime:
    ...
    def render(self, path: str, envelope: Envelope) -> Dict[str, Any]:
        ...
        return {
            "layout": view.model_dump(),
            "state": session.model_dump()
        }

    def handle_event(self, event_id: str, payload: Dict[str, Any], envelope: Envelope) -> Dict[str, Any]:
        """
        Handles a UI event.
