...
def get_capabilities() -> Dict[str, Any]:
    ...
    return {
        ...
        "supported_components": ["container", "text", "button", "input", "form", "table", "card"],
...
@mcp.tool()
def render_view(path: str, session_id: str, user_id: str = None, device_context: str = None, theme_preference: str = None) -> Dict[str, Any]:
    """
...
@mcp.tool()
def handle_event(event_id: str, payload: Dict[str, Any], session_id: str, user_id: str = None) -> Dict[str, Any]:
    """
